      ...
      <Container className={styles.container}>
        <div className={styles.layout}>
          ...
          <Reveal className={styles.content} delay={0.1}>
            <p>
              Прокладываем трассу кондицонера по технической карте и исключаем пересечения с важными
              узлами, из-за которых теряется высота потолка еще на 5-7 см дополнительно к проектному
              опуску 8-10см
            </p>
