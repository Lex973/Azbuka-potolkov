      ...
      <Container>
        <div className={styles.layout}>
          <Reveal className={styles.copy}>
            <p className={styles.eyebrow}>Акустический текстиль</p>
            <h2 id="quiet-walls-title">Тихие стены</h2>
            <span className={styles.rule} aria-hidden="true" />
            <div className={styles.text}>
              <p>
                Мы также занимаемся тихими стенами — система отделки декоративным текстилем
                (визуально не отличается от декоративной штукатурки), которая помогает сделать
                ремонт быстрее и сразу создать комфортную акустику в помещении.
              </p>
              <p>
                Благодаря готовой технологии целую квартиру можно привести к финишу в 5 раз быстрее.
                Поверхности выглядят аккуратно, их можно мыть и протирать, не собирается пыль, а в
                комнате становится заметно спокойнее и комфортнее.
              </p>
            </div>
            <a
          ...
          <Reveal className={styles.media} delay={0.12}>
            ...
            <span className={styles.caption}>
              Акустическая отделка · тихие стены · декоративная ткань
            </span>
          </Reveal>
        </div>
      </Container>
